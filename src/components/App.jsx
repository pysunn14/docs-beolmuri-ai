      ...
      <div className="workspace">
        ...
        <main key={docId} className="document" id="main-content">
          ...
          <section id="intro" className="intro-section">
            ...
            <p className="lead">{markdownDoc?.description ?? '아직 공개한 글이 없습니다.'}</p>
          </section>
          {markdownDoc && <>
